                ...
                <Table.Column
                    ...
                    render={(id) => {
                        return (
                            <>
                                <Space>
                                    <ShowButton resource="renewals" type="primary" hideText shape="circle" size="small" recordItemId={id} />
                                    <EditButton resource="renewals" type="primary" hideText shape="circle" size="small" recordItemId={id} />
                                    <DeleteButton resource="renewals" type="primary" danger hideText shape="circle" size="small" recordItemId={id} />
                                </Space>
                            </>
                        );
                    }}
