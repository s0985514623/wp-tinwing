            ...
            <Table
                ...
                <Table.Column
                    ...
                    onFilter={(value, record: DataType) => {
                        if (value === 'others') return record?.template !== 'general' && record?.template !== 'motor' && record?.template !== 'shortTerms' && record?.template !== 'package';
                ...
                <Table.Column
                    ...
                    render={(id) => {
                        return (
                            <>
                                <Space>
                                    <ShowButton resource="quotations" type="primary" hideText shape="circle" size="small" recordItemId={id} />
                                    <EditButton resource="quotations" type="primary" hideText shape="circle" size="small" recordItemId={id} />
                                    <DeleteButton resource="quotations" type="primary" danger hideText shape="circle" size="small" recordItemId={id} />
                                </Space>
                            </>
                        );
                    }}
