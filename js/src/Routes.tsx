...
import { ListView as DebitNoteList, EditView as DebitNoteEdit, CreateView as DebitNoteCreate, ShowView as DebitNoteShow } from './pages/debitNotes';

import { ListView as QuotationList, EditView as QuotationEdit, CreateView as QuotationCreate, ShowView as QuotationShow } from './pages/quotations';

import { ListView as RenewalList, EditView as RenewalEdit, CreateView as RenewalCreate, ShowView as RenewalShow } from './pages/renewals';

import { ListView as ReceiptList, EditView as ReceiptEdit, CreateView as ReceiptCreate, ShowView as ReceiptShow } from './pages/receipts';

import { ListView as ClientList, EditView as ClientEdit, CreateView as ClientCreate } from './pages/clients';

import { ListView as InsurerList, EditView as InsurerEdit, CreateView as InsurerCreate } from './pages/insurers';

import { ListView as InsurerProductList, EditView as InsurerProductEdit, CreateView as InsurerProductCreate } from './pages/insurerProducts';

import { ListView as AgentList, EditView as AgentEdit, CreateView as AgentCreate } from './pages/agents';

import { ListView as TermList, EditView as TermEdit, CreateView as TermCreate } from './pages/terms';
    ...
    return (
        <Routes>
            <Route
                ...
                <Route index element={<NavigateToResource resource="clientsSummary" />} />
                ...
                <Route path="/terms/insurance_class">
                    ...
                    <Route path="create" element={<TermCreate taxonomy="insurance_class" />} />
                    <Route path="edit/:id" element={<TermEdit taxonomy="insurance_class" />} />
                </Route>
                ...
                <Route
                    ...
                    element={
                        <AuthPage
                            ...
                            wrapperProps={{
                                style: {
                                    backgroundImage: 'url(https://images.unsplash.com/photo-1508108712903-49b7ef9b1df8?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2669&q=80)',
