...
final class CreditNotes {
	...
	public function __construct() {
		\add_action( 'rest_api_init', [ $this, 'register_api_credit_notes' ] );
	}
	 ...
	 * @return void
	 */
	public function register_api_credit_notes(): void {
		$this->register_apis(
			apis: $this->get_apis(),
	...
	/**
	 * Get credit_notes callback
	 *
	 * @param \WP_REST_Request $request Request.
	 * @return \WP_REST_Response
	 */
	public function get_credit_notes_callback( $request ) { // phpcs:ignore
		$params = $request->get_query_params() ?? [];
		$params = WP::sanitize_text_field_deep( $params, false );
		// 查詢 Custom Post Type 'credit_notes' 的文章
		$args = [
			'post_type'      => 'credit_notes',   // 自定義文章類型名稱
	...
	/**
	 * Create credit_notes callback
	 *
	 * @param \WP_REST_Request $request Request.
	 * @return \WP_REST_Response
	 */
	public function post_credit_notes_callback( $request ) { // phpcs:ignore
	...
	/**
	 * Update credit_notes callback
	 *
	 * @param \WP_REST_Request $request Request.
	 * @return \WP_REST_Response
	 */
	public function post_credit_notes_with_id_callback( $request ) { // phpcs:ignore
		$params     = $request->get_json_params() ?? [];
		$params     = WP::sanitize_text_field_deep( $params, false );
	...
	/**
	 * Get credit_notes by id callback
	 *
	 * @param \WP_REST_Request $request Request.
	 * @return \WP_REST_Response
	 */
	public function get_credit_notes_with_id_callback( $request ) { // phpcs:ignore
		$post_id = $request->get_param('id');
		// $post    = get_post($post_id);
		$args  = [
			'post_type' => 'credit_notes',  // 指定自定义文章类型
			// 'p'         => $post_id, // 文章 ID
	...
	/**
	 * Delete credit_notes by id callback
	 *
	 * @param \WP_REST_Request $request Request.
	 * @return \WP_REST_Response
	 */
	public function delete_credit_notes_with_id_callback( $request ) { // phpcs:ignore
		$post_id = $request->get_param('id');
		// 刪除文章
